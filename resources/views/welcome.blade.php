...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <button class="w3-button w3-padding-16 w3-right" onclick="window.location.href='/register'">register</button>
    <div class="w3-center w3-padding-16">CMAT DII : Digital Industry Integration</div>
  </div>
</div>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    <div class="w3-quarter">
      <img src="logo.png" alt="Sandwich" style="width:100%">
